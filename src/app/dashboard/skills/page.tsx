...
import { getUserSkills, getAllSkills, addUserSkill, removeUserSkill, updateUserSkillLevel, UserSkillInfo } from '@/lib/skills/skillService';
...
export default function SkillsPage() {
  ...
  const handleAddSkill = async (e: React.FormEvent) => {
    ...
    try {
      // The updated function now returns the new skills list
      const updatedSkills = await addUserSkill(user.id, selectedSkill, proficiencyLevel);
      
      // Update state with the returned skills
